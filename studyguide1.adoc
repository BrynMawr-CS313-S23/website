...
2) Suppose a point p has barycentric coordinate (1,0,0) in relation to the triangle with points a, b, and c. What can we tell about the point p?o
...
6) Suppose we have a forward direction (-1,2,0). Construct an orthogonal basis for which (-1,2,0) corresopnds to the Z-axis with respect to the world coordinate frame. 
...
7) Consider again the unit cube. Suppose we translate it by (10,-5,2) and then rotate it by 30 degrees. What will be the final position of the top, right corner?
