...
|13
|April 11,13
|*Materials II* anchor:week13[]

* Topics: Environment mapping, reflection, transparency, glow, shadows
...
* Topics: Introduction to ray tracing and ray marching, intersction testing, signed-distance functions
