...
[unstyled]
* Topic this week: link:#week11[LaJune McMillian!, Matrices]
* link:asst05.html[Assignment 5 - Part 2] is due Thursday, April 6
* Quiz in Lab. Check out the study guide for practice. link:studyguide02.html[Study Guide 02]
